...
import com.xh.lesson.vo.req.LoginReqVO;
import com.xh.lesson.vo.req.RegisterReqVO;
import com.xh.lesson.vo.req.UpdatePasswordReqVO;
import com.xh.lesson.vo.req.UserAddReqVO;
import com.xh.lesson.vo.req.UserPageReqVO;
import com.xh.lesson.vo.req.UserUpdateReqVO;
...
public class UserController {
    ...
    @GetMapping("/po/board")
    @ApiOperation(value = "引导客户端去登录")
    public DataResult findProductionPOBoardData(){
        DataResult result= DataResult.success();
        try {
			result.setData(ApiUtil.getList("findProductionPOBoardData"));
		} catch (Exception e) {
